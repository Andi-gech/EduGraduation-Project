...
import svg from "../assets/teacher.svg";
...
<Snackbar
      ...
      <div className="w-[350px] h-[520px] flex flex-col mx-auto p-6 bg-gradient-to-r from-orange-200 to-yellow-100 shadow-lg rounded-lg">
        ...
        <div className="flex justify-between mt-6">
          ...
          <button
            ...
            onClick={handleNext}
            disabled={activeStep === 1 && !teacherData.agreeToPrivacy}
          >
